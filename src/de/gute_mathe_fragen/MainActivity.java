...
private static final String DEBUG_TAG = "gmf-debug";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("first").setIndicator("Webseite"/*,getResources().getDrawable(R.drawable.home)*/).setContent(new Intent(this  ,WebViewseite.class )));
        mTabHost.addTab(mTabHost.newTabSpec("second").setIndicator("Fragenliste"/*,getResources().getDrawable(R.drawable.fragezeichenklein))*/).setContent(new Intent(this , Fragen.class )));
