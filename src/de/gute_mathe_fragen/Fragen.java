...
public class Fragen extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        ...
	        case R.id.impressum:
	        	MainActivity tabAct = (MainActivity)getParent();
			    tabAct.setURL("http://www.gute-mathe-fragen.de/impressum");
			    tabAct.getTabHost().setCurrentTab(0);
	        	 return true;
	        case R.id.setting:
	...
	private void async (){		//Internet prüfen und Async starten
		ConnectivityManager connMgr = (ConnectivityManager) 
		        getSystemService(Context.CONNECTIVITY_SERVICE);
		    NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
		    if (networkInfo != null && networkInfo.isConnected()) { //Internet verfügbar
	...
	private class rsstask extends AsyncTask<String, Integer, String>{
		...
		protected String doInBackground(String... arg0) {
			...
			try {
				URL url = new URL("http://www.gute-mathe-fragen.de/feed/questions.rss");
